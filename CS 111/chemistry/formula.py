...
# def split_before_caps(formula):
#     # Split before capital letters 
#     result = re.split(r'(?=[A-Z])', formula)
#     return result

# def split_before_number(list):
#     formula_list = []
#     for i in range(len(list)):
#         result = re.split(r'(?=\d)', list[i])
#         formula_list.append(result)
#     return formula_list
...
def parse_formula(formula, periodic_table_dict):
    ...
    """
    # split = split_before_caps(formula)
    # formula_list = split_before_number(split)
